...
inspirations:
[url](https://quantifyinghealth.com/interpret-logistic-regression-intercept/)
[url](https://quantifyinghealth.com/interpret-logistic-regression-coefficients/)
...
df_titanic<- read.csv('https://web.stanford.edu/class/archive/cs/cs109/cs109.1166/stuff/titanic.csv') %>%
  mutate(Fare=round(Fare),
         independent=Siblings.Spouses.Aboard) #Fare to opłata za bilet
```
